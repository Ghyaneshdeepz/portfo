    ...
    transition-shadow duration-300 overflow-hidden "
            ...
            <div className="relative col-span-2 bg-[#0A0A0A] text-white p-6 rounded-xl border border-[#111111] 
              ...
              <div className="grid px-3 mt-5 grid-cols-4 gap-3 group relative ">
                <div className="p-3 rounded-2xl cursor-pointer bg-gradient-to-b from-[#2b2c2c] to-transparent 
                ...
                <div className="p-3 rounded-2xl cursor-pointer bg-gradient-to-b from-[#2b2c2c] to-transparent 
                  ...
                  <p className="text-xs mt-1 text-gray-500 font-medium">Using GCP, BigQuery and lookerstudio</p>
                </div>
                ...
                <div className="p-3 rounded-2xl cursor-pointer bg-gradient-to-b from-[#2b2c2c] to-transparent 
                  ...
                  group-hover:blur-[2px] hover:!blur-none">
                  <h1 className="text-sm font-semibold">Face Reco Attendence system</h1>
                  <p className="text-xs mt-1 text-gray-500 font-medium">Using React and TailwindCSS</p>
                </div>
              </div>
