    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center text-white px-6">
      ...
      <div className="relative z-20 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 mt-10">
          ...
          <button className="bg-white text-black font-semibold py-2 px-6 rounded-md w-full sm:w-auto transition-transform duration-200 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50">
            Let's Connect
          </button>
